...
#include "QCatGrayTeachingToolProtractor.h"
...
const QRectF QCatGrayTeachingToolProtractor::sDefaultRect = DefaultRect;
...
private:
    void InitProperty( void )
    {
        ...
        SetAngleButtonSvg(":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/svg/angleMarker.svg");
    }
    ...
    void PaintButton()
    {
     ...
     bool State( void )
     {
         QCatGrayTeachingToolProtractor *m_pTeachingToolProtractor = dynamic_cast<QCatGrayTeachingToolProtractor*>(this->parentItem());
         if(m_pTeachingToolProtractor->GetState() == QCatGrayAbsTeachingTool::TEAHINGTOOL_STATE_PEN
                 || m_pTeachingToolProtractor->GetState() == QCatGrayAbsTeachingTool::TEAHINGTOOL_STATE_DORMANCY)
         {
            return false;
         }
         return true;
...
private:
    ...
    QString AngleButtonSvg = ":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/svg/angleMarker.svg";
...
QCatGrayTeachingToolProtractor::QCatGrayTeachingToolProtractor()
{
    InitProperty();
}
...
QRectF QCatGrayTeachingToolProtractor::boundingRect() const
{
    QRectF rectf = QRectF(-angleButtonSize, -angleButtonSize,
...
void QCatGrayTeachingToolProtractor::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
    painter->setRenderHint(QPainter::Antialiasing, true);
...
QPainterPath QCatGrayTeachingToolProtractor::shape() const
{
    QPainterPath path;
...
void QCatGrayTeachingToolProtractor::SetCloseButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolProtractor::SetResizeButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolProtractor::SetRotateButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolProtractor::SetRestButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolProtractor::SetProtractorBackgroundColor(QColor color)
{
    ProtractorBackgroundColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolProtractor::SetProtractorBorderColor(QColor color)
{
    ProtractorBorderColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolProtractor::SetProtractorTextColor(QColor color)
{
    ProtractorTextColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolProtractor::SetProtractorScaleColor(QColor color)
{
    ProtractorScaleColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolProtractor::SetProtractorAxleColor(QColor color)
{
    ProtractorAxleColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolProtractor::InitProperty()
{
    ...
    SetRestButtonSvg(":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/svg/resetTool.svg");
    ...
    SetResizeButtonSvg(":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/svg/resizeTool.svg");
    m_pResizeButton->setVisible(false);


}

QRectF QCatGrayTeachingToolProtractor::CloseButtonRect() const
{
...
QRectF QCatGrayTeachingToolProtractor::ResizeButtonRect() const
{
...
QRectF QCatGrayTeachingToolProtractor::RotateButtonRect() const
{
...
QRectF QCatGrayTeachingToolProtractor::RestButtonRect() const
{
...
void QCatGrayTeachingToolProtractor::UpdateResizeCursor()
{
...
void QCatGrayTeachingToolProtractor::SetCursor(QCursor cursor)
{
...
void QCatGrayTeachingToolProtractor::PaintBackground(QPainter *painter)
{
    painter->save();
...
void QCatGrayTeachingToolProtractor::PaintScale(QPainter *painter)
{
    painter->save();
    // [0] 绘制中轴线
    painter->save();
...
void QCatGrayTeachingToolProtractor::PaintProtractorAxis(QPainter *painter)
{
    painter->save();
...
void QCatGrayTeachingToolProtractor::PaintButton()
{
    // [0] close 按钮
...
QPainterPath QCatGrayTeachingToolProtractor::ProtractorBackgroundPath() const
{
    QPainterPath path;
...
void QCatGrayTeachingToolProtractor::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
...
void QCatGrayTeachingToolProtractor::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void QCatGrayTeachingToolProtractor::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    Q_UNUSED(event)
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
...
void QCatGrayTeachingToolProtractor::hoverMoveEvent(QGraphicsSceneHoverEvent *event)
{
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
        if(ResizeButtonRect().contains(event->pos()))
...
void QCatGrayTeachingToolProtractor::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
    Q_UNUSED(event)
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
...
void QCatGrayTeachingToolProtractor::hoverLeaveEvent(QGraphicsSceneHoverEvent *event)
{
    Q_UNUSED(event)
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
