...
#include "QCatGrayAbsTeachingTool.h"
#include <QGraphicsEllipseItem>

class ProtractorAngle;

class QCatGrayTeachingToolProtractor : public QCatGrayAbsTeachingTool, public QGraphicsEllipseItem
{
    Q_OBJECT
    Q_INTERFACES(QGraphicsItem)
public:
    QCatGrayTeachingToolProtractor();
    ~QCatGrayTeachingToolProtractor();
