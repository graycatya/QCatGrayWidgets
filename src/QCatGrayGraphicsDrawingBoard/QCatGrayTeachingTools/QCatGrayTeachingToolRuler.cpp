...
QCatGrayTeachingToolRuler::QCatGrayTeachingToolRuler()
{
    InitProperty();
}
...
QRectF QCatGrayTeachingToolRuler::boundingRect() const
{
    return Rect();
}

void QCatGrayTeachingToolRuler::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
    // 打开抗锯齿
...
QPainterPath QCatGrayTeachingToolRuler::shape() const
{
    QPainterPath path;
...
void QCatGrayTeachingToolRuler::SetRulerBorderRadius(int radius)
{
    RulerBorderRadius = radius;
}

void QCatGrayTeachingToolRuler::SetRulerBackgroundColor(QColor color)
{
    RulerBackgroundColor = color;
}

void QCatGrayTeachingToolRuler::SetRulerBorderColor(QColor color)
{
    RulerBorderColor = color;
}

void QCatGrayTeachingToolRuler::SetRulerScaleTextColor(QColor color)
{
    RulerScaleTextColor = color;
}

void QCatGrayTeachingToolRuler::SetRulerScaleColor(QColor color)
{
    RulerScaleColor = color;
}

void QCatGrayTeachingToolRuler::SetRulerRotateColor(QColor color)
{
    RulerRotateColor = color;
}

void QCatGrayTeachingToolRuler::SetCloseButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolRuler::SetResizeButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolRuler::SetRotateButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolRuler::InitProperty()
{
    ...
    SetResizeButtonSvg(":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/svg/resizeRuler.svg");
...
void QCatGrayTeachingToolRuler::UpdateResizeCursor()
{
...
void QCatGrayTeachingToolRuler::SetCursor(QCursor cursor)
{
...
QRectF QCatGrayTeachingToolRuler::CloseButtonRect() const
{
...
QRectF QCatGrayTeachingToolRuler::ResizeButtonRect() const
{
...
QRectF QCatGrayTeachingToolRuler::RotateButtonRect() const
{
...
void QCatGrayTeachingToolRuler::PaintBody(QPainter *painter)
{
...
void QCatGrayTeachingToolRuler::PaintButton()
{
    // [1] resize按钮
...
void QCatGrayTeachingToolRuler::PaintScale(QPainter *painter)
{
...
void QCatGrayTeachingToolRuler::PaintRotate(QPainter *painter)
{
    QPen pen = painter->pen();
...
void QCatGrayTeachingToolRuler::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
...
void QCatGrayTeachingToolRuler::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void QCatGrayTeachingToolRuler::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    Q_UNUSED(event)
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
...
void QCatGrayTeachingToolRuler::hoverMoveEvent(QGraphicsSceneHoverEvent *event)
{
    Q_UNUSED(event)
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
...
void QCatGrayTeachingToolRuler::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
    Q_UNUSED(event)
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
...
void QCatGrayTeachingToolRuler::hoverLeaveEvent(QGraphicsSceneHoverEvent *event)
{
    Q_UNUSED(event)
