#include "QCatGrayTeachingToolTrangle.h"
...
QCatGrayTeachingToolTrangle::QCatGrayTeachingToolTrangle()
{
    InitProperty();
}
...
QRectF QCatGrayTeachingToolTrangle::boundingRect() const
{
    return Rect();
}

void QCatGrayTeachingToolTrangle::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
...
QPainterPath QCatGrayTeachingToolTrangle::shape() const
{
    QPainterPath path;
    QPolygonF polygon;
...
void QCatGrayTeachingToolTrangle::SetCloseButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolTrangle::SetRotateButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolTrangle::SetFlipHorizontalButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolTrangle::SetFlipVerticalButtonSvg(QString svg)
{
...
void QCatGrayTeachingToolTrangle::SetTrangleBorderColor(QColor color)
{
    TrangleBorderColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolTrangle::SetTrangleBackgroundColor(QColor color)
{
    TrangleBackgroundColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolTrangle::SetTrangleResizeButtonColor(QColor color)
{
    TrangleResizeButtonColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolTrangle::SetTrangleScaleTextColor(QColor color)
{
    TrangleScaleTextColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolTrangle::SetTrangleScaleColor(QColor color)
{
    TrangleScaleColor = color;
    prepareGeometryChange();
}

void QCatGrayTeachingToolTrangle::Move(QPointF lastpot, QPointF currentpot)
{
...
void QCatGrayTeachingToolTrangle::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    UpdateOriginPos();
...
void QCatGrayTeachingToolTrangle::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void QCatGrayTeachingToolTrangle::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    Q_UNUSED(event)
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
...
void QCatGrayTeachingToolTrangle::hoverMoveEvent(QGraphicsSceneHoverEvent *event)
{
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
        if(GetState() != TEAHINGTOOL_STATE_PEN)
...
void QCatGrayTeachingToolTrangle::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
    Q_UNUSED(event)
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
...
void QCatGrayTeachingToolTrangle::hoverLeaveEvent(QGraphicsSceneHoverEvent *event)
{
    Q_UNUSED(event)
    if(GetState() != TEAHINGTOOL_STATE_DORMANCY)
    {
...
void QCatGrayTeachingToolTrangle::InitProperty()
{
    RotateCursor = QCursor(QPixmap(":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/png/rotate.png"), 16, 16);
    DrawLineRulerCursor = QCursor(QPixmap(":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/png/drawRulerLine.png"), 5, 16);
    ...
    m_pCloseButton->setVisible(false);
    SetRotateButtonSvg(":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/svg/rotateTool.svg");
    m_pRotateButton->setVisible(false);
    SetFlipVerticalButtonSvg(":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/svg/vflipTool.svg");
    m_pFlipVerticalButton->setVisible(false);
    SetFlipHorizontalButtonSvg(":/QCatGrayWidgets/QCatGrayGraphicsDrawingBoard/QCatGrayTeachingTools/svg/hflipTool.svg");
    m_pFlipHorizontalButton->setVisible(false);
...
void QCatGrayTeachingToolTrangle::UpdateResizeCursor()
{
...
void QCatGrayTeachingToolTrangle::SetCursor(QCursor cursor)
{
...
void QCatGrayTeachingToolTrangle::SetOrientation(QCatGrayTeachingToolTrangle::TRANGLEORIENTATION orientation)
{
    mOrientation = orientation;
    CalculatePoints(Rect());
}

void QCatGrayTeachingToolTrangle::UpdateOriginPos()
{
    switch (mOrientation) {
        case BottomLeft:{
...
void QCatGrayTeachingToolTrangle::UpdateResize1RectF(QPointF pos)
{
    if (mOrientation == TopLeft || mOrientation == BottomLeft)
    {
...
void QCatGrayTeachingToolTrangle::UpdateResize2RectF(QPointF pos)
{
...
void QCatGrayTeachingToolTrangle::CalculatePoints(const QRectF &r)
{
    switch (mOrientation) {
        case BottomLeft:{
            A1 = r.topLeft();
...
QRectF QCatGrayTeachingToolTrangle::CloseButtonRect() const
{
    switch(mOrientation)
    {
        case BottomLeft:
...
QRectF QCatGrayTeachingToolTrangle::RotateButtonRect() const
{
    QPointF p(C2);
...
QRectF QCatGrayTeachingToolTrangle::FlipVerticalButtonRect() const
{
...
QRectF QCatGrayTeachingToolTrangle::FlipHorizontalButtonRect() const
{
...
QPolygonF QCatGrayTeachingToolTrangle::resize1Polygon() const
{
    qreal x1, y1;
    switch (mOrientation)
    {
...
QPolygonF QCatGrayTeachingToolTrangle::resize2Polygon() const
{
    qreal x1, y1;
    switch (mOrientation) {
        case BottomLeft:{
...
QCursor QCatGrayTeachingToolTrangle::resizeCursor1() const
{
    return mResizeCursor1;
}

QCursor QCatGrayTeachingToolTrangle::resizeCursor2() const
{
    return mResizeCursor2;
}

QCatGrayTeachingToolTrangle::TRANGLEORIENTATION QCatGrayTeachingToolTrangle::VerticalOrientation(QCatGrayTeachingToolTrangle::TRANGLEORIENTATION Orientation)
{
    QCatGrayTeachingToolTrangle::TRANGLEORIENTATION temp = Orientation;
...
QCatGrayTeachingToolTrangle::TRANGLEORIENTATION QCatGrayTeachingToolTrangle::HorizontalOrientation(QCatGrayTeachingToolTrangle::TRANGLEORIENTATION Orientation)
{
    QCatGrayTeachingToolTrangle::TRANGLEORIENTATION temp = Orientation;
    if(Orientation == BottomLeft)
    {
...
QPointF QCatGrayTeachingToolTrangle::rotationCenter() const
{
    switch(mOrientation)
    {
        case BottomLeft:
...
void QCatGrayTeachingToolTrangle::rotateAroundCenter(qreal angles)
{
...
void QCatGrayTeachingToolTrangle::rotateAroundCenter(QTransform &transform, QPointF center)
{
...
void QCatGrayTeachingToolTrangle::paintGraduations(QPainter *painter)
{
...
qreal QCatGrayTeachingToolTrangle::angleInDegrees() const
{
    QRectF itemRect = boundingRect();
    QTransform itemTransform = sceneTransform();
    QPointF topLeft = itemTransform.map(itemRect.topLeft());
...
QPointF QCatGrayTeachingToolTrangle::UpdatePenPos(QGraphicsSceneMouseEvent *event)
{
    QPointF pos = event->pos();
