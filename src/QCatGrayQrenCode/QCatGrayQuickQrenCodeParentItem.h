...
class QCatGrayQuickQrenCodeParentItem : public QQuickPaintedItem
{
    Q_OBJECT
...
public:
    ...
    explicit QCatGrayQuickQrenCodeParentItem(QQuickItem *parent = nullptr);
    ~QCatGrayQuickQrenCodeParentItem() override;
