#include "QCatGrayQuickQrenCodeParentItem.h"
#include <QPainter>
...
QCatGrayQuickQrenCodeParentItem::QCatGrayQuickQrenCodeParentItem(QQuickItem *parent)
    : QQuickPaintedItem(parent)
{
    InitProperty();
}

QCatGrayQuickQrenCodeParentItem::~QCatGrayQuickQrenCodeParentItem()
{

}

QImage QCatGrayQuickQrenCodeParentItem::getQrenImage()
{
...
void QCatGrayQuickQrenCodeParentItem::paint(QPainter *painter)
{
    if(m_sText.isEmpty())
    {
        return;
...
void QCatGrayQuickQrenCodeParentItem::InitProperty()
{
    m_eQrmode = MODE_8;
    m_eQrlevel = LEVEL_Q;
    m_bCasesen = true;
