#include "QCatGrayQcustomplotAxisTag.h"

QCatGrayQcustomplotAxisTag::QCatGrayQcustomplotAxisTag(QCPAxis *parent)
    : QObject(parent)
    , m_pAxis(parent)
{
    InitUi();
...
QCatGrayQcustomplotAxisTag::~QCatGrayQcustomplotAxisTag()
{

}

void QCatGrayQcustomplotAxisTag::UpdatePosition(double value)
{
    /*
...
void QCatGrayQcustomplotAxisTag::InitUi()
{
...
void QCatGrayQcustomplotAxisTag::InitProperty()
{
    if(mDummyTracer)
...
void QCatGrayQcustomplotAxisTag::SetPen(const QPen &pen)
{
    mArrow->setPen(pen);
    mLabel->setPen(pen);
}

void QCatGrayQcustomplotAxisTag::SetLabelBrush(const QBrush &brush)
{
    mLabel->setBrush(brush);
}

void QCatGrayQcustomplotAxisTag::SetLabelText(const QString &text)
{
    mLabel->setText(text);
}
