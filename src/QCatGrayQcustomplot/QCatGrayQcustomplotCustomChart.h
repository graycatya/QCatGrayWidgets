...
class QCatGrayQcustomplotCustomChart : public QCatGrayQcustomplot
{
    Q_OBJECT
...
public:
    explicit QCatGrayQcustomplotCustomChart(QWidget *parent = nullptr);
    ~QCatGrayQcustomplotCustomChart();
