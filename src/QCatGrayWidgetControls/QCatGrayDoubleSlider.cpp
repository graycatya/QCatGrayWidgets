#include "QCatGrayDoubleSlider.h"
#include <QPainter>
...
QCatGrayDoubleSlider::QCatGrayDoubleSlider(QWidget *parent)
    : QWidget(parent)
...
QCatGrayDoubleSlider::~QCatGrayDoubleSlider()
{

}

void QCatGrayDoubleSlider::SetFromTo(qreal from, qreal to)
{
    if(from != to)
    {
        m_nFrom = from;
...
void QCatGrayDoubleSlider::SetFirst(qreal first)
{
    if(m_nFrom < m_nTo)
    {
...
void QCatGrayDoubleSlider::SetSecond(qreal second)
{
    if(m_nFrom < m_nTo)
    {
...
void QCatGrayDoubleSlider::SetFirstSecond(qreal first, qreal second)
{
    m_nFirst = first;
    m_nSecond = second;
    UpdateSlideCoordinates();
...
void QCatGrayDoubleSlider::SetFromToNotUpdate(qreal from, qreal to)
{
    if(from != to)
    {
        m_nFrom = from;
...
void QCatGrayDoubleSlider::InitUi()
{
}

void QCatGrayDoubleSlider::InitProperty()
{
    m_bMousePress = false;
    //添加自定义类控制
...
void QCatGrayDoubleSlider::InitRectfProperty()
{
...
void QCatGrayDoubleSlider::UpdateBackgroundSlide()
{
...
void QCatGrayDoubleSlider::Painter_Background_Rect(QPainter *painter)
{
    //Q_UNUSED(painter)
    painter->save();
...
void QCatGrayDoubleSlider::Painter_BackgroundSlide_Rect(QPainter *painter)
{
    //Q_UNUSED(painter)
    painter->save();
    painter->setRenderHint(QPainter::Antialiasing);
...
void QCatGrayDoubleSlider::Painter_Slide_LeftOrTop(QPainter *painter)
{
    //Q_UNUSED(painter)
    painter->save();
    painter->setRenderHint(QPainter::Antialiasing);
...
void QCatGrayDoubleSlider::Painter_Slide_RightOrBottom(QPainter *painter)
{
    //Q_UNUSED(painter)
    painter->save();
    painter->setRenderHint(QPainter::Antialiasing);
...
void QCatGrayDoubleSlider::LeftOrTopSelectDisPose(QMouseEvent *event)
{
...
void QCatGrayDoubleSlider::RightOrBottomSelectDisPose(QMouseEvent *event)
{
    QPointF movepos = event->pos() - m_pPressPoint;
    if(m_ySlideOrientationState == SliderHorizontal)
    {
...
void QCatGrayDoubleSlider::BackgroundSlideRectPose(QMouseEvent *event)
{
    QPointF movepos = event->pos() - m_pPressPoint;
...
void QCatGrayDoubleSlider::UpdateOrientation()
{
...
void QCatGrayDoubleSlider::UpdateFirstSecond()
{
    qreal width = 0;
    qreal first = 0;
    qreal second = 0;
...
void QCatGrayDoubleSlider::UpdateSlideCoordinates()
{
    if(m_ySlideOrientationState == SliderHorizontal)
    {
...
void QCatGrayDoubleSlider::setSlideOrientationState(QCatGrayDoubleSlider::OrientationState state)
{
...
void QCatGrayDoubleSlider::setSlideLeftColor(QBrush brush)
{
...
void QCatGrayDoubleSlider::setSlideRightColor(QBrush brush)
{
...
void QCatGrayDoubleSlider::setBackgroundRectColor(QBrush brush)
{
...
void QCatGrayDoubleSlider::setBackgroundSlideRectColor(QBrush brush)
{
...
void QCatGrayDoubleSlider::setSlideLeftBorderColor(QBrush color)
{
...
void QCatGrayDoubleSlider::setSlideRightBorderColor(QBrush color)
{
...
void QCatGrayDoubleSlider::setBackgroundRectBorderColor(QBrush color)
{
...
void QCatGrayDoubleSlider::setBackgroundSlideRectBorderColor(QBrush color)
{
...
void QCatGrayDoubleSlider::setHoverSlideLeftColor(QBrush brush)
{
    m_cHoverSlideLeftColor = brush;
    update();
}

void QCatGrayDoubleSlider::setHoverSlideRightColor(QBrush brush)
{
    m_cHoverSlideRightColor = brush;
    update();
}

void QCatGrayDoubleSlider::setHoverBackgroundRectColor(QBrush brush)
{
    m_cHoverBackgroundRectColor = brush;
    update();
}

void QCatGrayDoubleSlider::setHoverBackgroundSlideRectColor(QBrush brush)
{
    m_cHoverBackgroundSlideRectColor = brush;
    update();
}

void QCatGrayDoubleSlider::setHoverSlideLeftBorderColor(QBrush color)
{
    m_cHoverSlideLeftBorderColor = color;
    update();
}

void QCatGrayDoubleSlider::setHoverSlideRightBorderColor(QBrush color)
{
    m_cHoverSlideRightBorderColor = color;
    update();
}

void QCatGrayDoubleSlider::setHoverBackgroundRectBorderColor(QBrush color)
{
    m_cHoverBackgroundRectBorderColor = color;
    update();
}

void QCatGrayDoubleSlider::setHoverBackgroundSlideRectBorderColor(QBrush color)
{
    m_cHoverBackgroundSlideRectBorderColor = color;
    update();
}

void QCatGrayDoubleSlider::setPressSlideLeftColor(QBrush brush)
{
    m_cPressSlideLeftColor = brush;
    update();
}

void QCatGrayDoubleSlider::setPressSlideRightColor(QBrush brush)
{
    m_cPressSlideRightColor = brush;
    update();
}

void QCatGrayDoubleSlider::setPressBackgroundRectColor(QBrush brush)
{
    m_cPressBackgroundRectColor = brush;
    update();
}

void QCatGrayDoubleSlider::setPressBackgroundSlideRectColor(QBrush brush)
{
    m_cPressBackgroundSlideRectColor = brush;
    update();
}

void QCatGrayDoubleSlider::setPressSlideLeftBorderColor(QBrush color)
{
    m_cPressSlideLeftBorderColor = color;
    update();
}

void QCatGrayDoubleSlider::setPressSlideRightBorderColor(QBrush color)
{
    m_cPressSlideRightBorderColor = color;
    update();
}

void QCatGrayDoubleSlider::setPressBackgroundRectBorderColor(QBrush color)
{
    m_cPressBackgroundRectBorderColor = color;
    update();
}

void QCatGrayDoubleSlider::setPressBackgroundSlideRectBorderColor(QBrush color)
{
    m_cPressBackgroundSlideRectBorderColor = color;
    update();
}

void QCatGrayDoubleSlider::setBackgroundRadius(int radius)
{
    m_nBackgroundRadius = radius;
    update();
}

void QCatGrayDoubleSlider::setSlideRadius(int radius)
{
    m_nSlideRadius = radius;
    update();
}

void QCatGrayDoubleSlider::setSlideWidth(qreal width)
{
    m_nSlideWidth = width;
...
void QCatGrayDoubleSlider::setSlideHeight(qreal height)
{
...
void QCatGrayDoubleSlider::setBackgroundHeight(qreal height)
{
    m_nBackgroundHeight = height;
    update();
}

void QCatGrayDoubleSlider::setBackgroundSlideHeight(qreal height)
{
    m_nBackgroundSlideHeight = height;
    update();
}

void QCatGrayDoubleSlider::setSlideLeftBorderWidth(qreal width)
{
    m_nSlideLeftBorderWidth = width;
    update();
}

void QCatGrayDoubleSlider::setSlideRightBorderWidth(qreal width)
{
    m_nSlideRightBorderWidth = width;
    update();
}

void QCatGrayDoubleSlider::setBackgroundRectBorderWidth(qreal width)
{
    m_nBackgroundRectBorderWidth = width;
    update();
}

void QCatGrayDoubleSlider::setBackgroundSlideRectBorderWidth(qreal width)
{
    m_nBackgroundSlideRectBorderWidth = width;
    update();
}

void QCatGrayDoubleSlider::setSliderStyle(QCatGrayDoubleSlider::SliderStyles style)
{
...
void QCatGrayDoubleSlider::setSliderDataType(QCatGrayDoubleSlider::SliderDataTypes type)
{
...
void QCatGrayDoubleSlider::enterEvent(QEnterEvent *event)
#else
void QCatGrayDoubleSlider::enterEvent(QEvent *event)
#endif
{
    Q_UNUSED(event)
}

void QCatGrayDoubleSlider::leaveEvent(QEvent *event)
{
    Q_UNUSED(event)
    m_cCurrentSlideLeftColor = m_cSlideLeftColor;
    m_cCurrentSlideRightColor = m_cSlideRightColor;
...
void QCatGrayDoubleSlider::resizeEvent(QResizeEvent *event)
{
    Q_UNUSED(event)
    update();
}

void QCatGrayDoubleSlider::mouseMoveEvent(QMouseEvent *event)
{
...
void QCatGrayDoubleSlider::mousePressEvent(QMouseEvent *event)
{
    m_bMousePress = true;
    m_pPressPoint = event->pos();
...
void QCatGrayDoubleSlider::mouseReleaseEvent(QMouseEvent *event)
{
    Q_UNUSED(event)
    m_bMousePress = false;
    m_ySelectStyle = NotSelect;
...
void QCatGrayDoubleSlider::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
    UpdateOrientation();
...
bool QCatGrayDoubleSlider::eventFilter(QObject *o, QEvent *e)
{
    qDebug() << o->objectName();
