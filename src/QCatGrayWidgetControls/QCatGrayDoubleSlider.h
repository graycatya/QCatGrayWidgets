...
class QCatGrayDoubleSlider : public QWidget
{
    Q_OBJECT
...
public:
    ...
    explicit QCatGrayDoubleSlider(QWidget *parent = nullptr);
    ~QCatGrayDoubleSlider();
...
signals:
    void SlideOrientationStateChanged(QCatGrayDoubleSlider::OrientationState);
    void SliderStyleChanged(QCatGrayDoubleSlider::SliderStyles);
    void SliderDataTypeChanged(QCatGrayDoubleSlider::SliderDataTypes);
...
public slots:
    void setSlideOrientationState(QCatGrayDoubleSlider::OrientationState state);
    void setSliderStyle(QCatGrayDoubleSlider::SliderStyles style);
    void setSliderDataType(QCatGrayDoubleSlider::SliderDataTypes type);
